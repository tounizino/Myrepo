...
class CGT_Database {
	...
	public static function insert_default_platforms() {
		...
		$default_platforms = array(
			...
			array(
				...
				'icon_url'       => 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Xbox_one_console_Transparent.png/200px-Xbox_one_console_Transparent.png',
				'game_included'  => 1,
				'price'          => '15',
				'currency'       => '$',
				'cta_text'       => 'Play Now',
				'cta_url'        => 'https://www.xbox.com/en-US/play',
				'display_order'   => 2,
				'is_active'      => 1,
			),
			array(
				...
				'currency'       => '$',
				'cta_text'       => 'Play Now',
				'cta_url'        => 'https://playstation.com/ps-plus/',
				'display_order'   => 3,
				'is_active'      => 1,
			),
			array(
				'name'           => 'NVIDIA GeForce',
				'icon_url'       => 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/NVIDIA_Logo.svg/200px-NVIDIA_Logo.svg.png',
				'game_included'  => 0,
				'price'          => '20',
				'currency'       => '$',
				'cta_text'       => 'Play Now',
				'cta_url'        => 'https://www.nvidia.com/en-us/geforce-now/',
				'display_order'   => 4,
				'is_active'      => 1,
			),
			array(
				'name'           => 'Amazon Luna',
				'icon_url'       => 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_Luna_logo.svg/200px-Amazon_Luna_logo.svg.png',
				'game_included'  => 1,
				'price'          => '10',
				'currency'       => '$',
				'cta_text'       => 'Play Now',
				'cta_url'        => 'https://www.amazon.com/luna',
				'display_order'   => 5,
				'is_active'      => 1,
			),
			array(
				'name'           => 'Shadow',
				'icon_url'       => 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Shadow_%28company%29_logo.svg/200px-Shadow_%28company%29_logo.svg.png',
				'game_included'  => 0,
				'price'          => '12',
				'currency'       => '$',
				'cta_text'       => 'Play Now',
	...
	public static function get_platforms( $args = array() ) {
		...
		$results = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}cgt_platforms $where ORDER BY {$args['order_by']} {$args['order']}", ARRAY_A );
	...
	public static function get_game_availability( $game_id, $platform_id ) {
		global $wpdb;
